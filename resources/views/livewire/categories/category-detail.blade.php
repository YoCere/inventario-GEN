<x-modal name="category-detail-modal" focusable>
        ...
        <div class="p-6">
            ...
            <div class="mb-6 space-y-1.5 text-center sm:text-left border-b border-gray-200 pb-4">
                ...
                <p class="text-sm text-muted-foreground">
                    {{ __('Informacion detallada de') }} {{ $category->name }}.
                </p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-1">
                    <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('Descripcion') }}</label>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div class="space-y-1">
                        <label class="text-sm font-medium leading-none text-muted-foreground">{{ __('Ultima actualizacion') }}</label>
    ...
    @else
        <div class="p-8 text-center flex flex-col items-center justify-center space-y-3">
            ...
            <span class="text-sm text-muted-foreground">{{ __('Cargando detalle...') }}</span>
        </div>
    @endif
</x-modal>

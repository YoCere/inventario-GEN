    ...
    <div class="p-6">
        ...
        <div class="mb-6 space-y-1.5 text-center sm:text-left border-b border-gray-200 pb-4">
            <h3 class="text-lg font-semibold leading-none tracking-tight text-foreground">
                {{ $isEditing ? 'Editar Categoría Financiera' : 'Crear Categoría Financiera' }}
            </h3>
            <p class="text-sm text-muted-foreground">
                {{ $isEditing ? 'Realice cambios en su categoría aquí. Haga clic en guardar cuando haya terminado.' : 'Agregue una nueva categoría a sus registros financieros.' }}
            </p>
        </div>
        ...
        <form wire:submit="save" class="space-y-4">
            ...
            <x-form-input
                ...
                type="text"
                wire:model="name"
                placeholder="Ej. Electricidad, Salario de Empleados, Ventas de Activos"
                required
            />

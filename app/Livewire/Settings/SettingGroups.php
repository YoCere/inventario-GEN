...
class SettingGroups extends Component
{
    ...
    private const GROUP_KEYS = [
        ...
        'impuestos' => [
            ...
            // Cierre de gestión (IUE / reserva legal)
            'company_entity_type',
            'tax_iue_rate',
            'legal_reserve_rate',
            'legal_reserve_cap_pct',
    ...
    protected function labelFor(string $key): string
    {
        return match ($key) {
            ...
            'company_entity_type' => 'Tipo de sociedad (para reserva legal)',
            'tax_iue_rate' => 'IUE (%)',
            'legal_reserve_rate' => 'Reserva legal (%)',
            'legal_reserve_cap_pct' => 'Tope reserva legal (% del capital)',
    ...
    protected function formatValue(string $key, string $value): string
    {
        return match ($key) {
            ...
            'payroll_aguinaldo_provision_rate', 'payroll_indemnization_provision_rate',
            'tax_iue_rate', 'legal_reserve_rate', 'legal_reserve_cap_pct' => $value . '%',
            'company_entity_type' => match ($value) {
                'srl' => 'S.R.L.',
                'sa'  => 'S.A.',

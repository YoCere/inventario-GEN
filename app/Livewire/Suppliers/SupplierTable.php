...
final class SupplierTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('proveedores_exportacion_' . now()->format('Y_m_d'))
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Persona de Contacto', 'contact_person')
                ->sortable()
                ->searchable(),
    ...
    public function delete($rowId, SupplierService $supplierService): void
    {
        ...
        if ($supplier) {
            try {
                ...
                $this->dispatch('toast', message: 'Proveedor eliminado correctamente.', type: 'success');
            } catch (\Exception $e) {

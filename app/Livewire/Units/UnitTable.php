        ...
        return [
            ...
            Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => "¿Seguro que deseas eliminar la unidad '{$row->name}'? Esta acción no se puede deshacer.",
                ])
    ...
    public function delete($rowId, UnitService $service): void
    {
        ...
        if ($unit) {
            try {
                ...
                $this->dispatch('toast', message: 'Unidad eliminada correctamente.', type: 'success');
            } catch (\Exception $e) {
                $message = $e instanceof UnitException
                    ? $e->getMessage()
                    : 'Error al eliminar unidad: ' . $e->getMessage();

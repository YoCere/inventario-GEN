...
final class PurchaseTable extends PowerGridComponent
{
    ...
    public function actions(Purchase $row): array
    {
        ...
        // Accion Editar (Solo Borrador o Pedido)
        ...
        // Accion Eliminar (Solo Borrador o Cancelado)
        if (in_array($row->status, [PurchaseStatus::DRAFT, PurchaseStatus::CANCELLED])) {
            $actions[] = Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => "Seguro que deseas eliminar la factura '{$row->invoice_number}'? Esta accion no se puede deshacer.",
                ])
    ...
    public function delete($rowId, PurchaseService $purchaseService): void
    {
        ...
        if ($purchase) {
            try {
                ...
                $this->dispatch('toast', message: 'Ocurrio un error inesperado durante la eliminacion.', type: 'error');
            }
        }
    }
}

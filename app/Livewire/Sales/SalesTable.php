...
final class SalesTable extends PowerGridComponent
{
    ...
    public function setUp(): array
    {
        ...
        return [
            PowerGrid::exportable('ventas_exportacion_' . now()->format('Y_m_d'))
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('customer_name', fn(Sale $model) => $model->customer ? $model->customer->name : 'Invitado')
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Factura', 'invoice_number')
                ->searchable()
                ->sortable(),

            Column::make('Cliente', 'customer_name', 'customer_id')
                ->searchable()
                ->sortable(),
    ...
    public function delete($rowId, SaleService $saleService): void
    {
        ...
        if ($sale) {
            try {
                ...
                $this->dispatch('toast', message: 'Venta eliminada correctamente.', type: 'success');

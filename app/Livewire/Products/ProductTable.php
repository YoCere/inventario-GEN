...
final class ProductTable extends PowerGridComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Categoria', 'category_name', 'category_id')
                ->sortable()
                ->searchable()
                ->visibleInExport(false),

            Column::make('Categoria', 'category_slug', 'category_id')
                ->hidden()
                ->visibleInExport(true),
        ...
        if ($isAdmin) {
            ...
            $actions[] = Button::add('delete')
                ...
                ->dispatch('open-delete-modal', [
                    ...
                    'description' => "Seguro que deseas eliminar el producto '{$row->name}'? Esta accion no se puede deshacer.",
                ])

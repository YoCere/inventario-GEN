...
final class ChartOfAccountTable extends PowerGridComponent
{
    ...
    public function actions(ChartOfAccount $row): array
    {
        ...
        $toggleClass = $row->is_active
            ? 'border border-rose-200 text-rose-600 hover:bg-rose-50 dark:border-rose-900 dark:text-rose-400 dark:hover:bg-rose-950/40 px-3 py-2 rounded-md text-xs font-medium'
            : 'border border-emerald-200 text-emerald-700 hover:bg-emerald-50 dark:border-emerald-900 dark:text-emerald-400 dark:hover:bg-emerald-950/40 px-3 py-2 rounded-md text-xs font-medium';
